...
//   it("should return true if balanced brackets", function() {
//     expect(balancedBrackets('[he] llo')).toBe(true);
//     exppect(balancedBrackets('(hello) [world]')).toBe(true);
//     expect(balancedBrackets('[hello (world])')).toBe(false);
//   });
// });